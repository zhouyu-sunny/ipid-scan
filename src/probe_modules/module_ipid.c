...
static int ipid_scan_init_thread(void* buf, macaddr_t *src,
...
static int ipid_scan_make_packet(void *buf, ipaddr_n_t src_ip, ipaddr_n_t dst_ip,
...
static void ipid_scan_print_packet(FILE *fp, void* packet)
{
...
static void ipid_scan_process_packet(const u_char *packet,
...
probe_module_t module_ipid = {
        ...
        .pcap_snaplen = 96,
        .port_args = 0,
        .thread_initialize = &ipid_scan_init_thread,
        .make_packet = &ipid_scan_make_packet,
        .print_packet = &ipid_scan_print_packet,
        .process_packet = &ipid_scan_process_packet,
